                    ...
                    <div class="bigdatatBtmLeftBtm">
                        <div class="batics">
                            ...
                            <div class="bigdatatBtmLeftBtmContent">
                                <span class="font14size999">{{ uuObj.tit41 }}: </span><span style="font-size:20px;color:#437BF5;font-weight:bold;">{{total}}</span>
                            </div>
                        </div>
...
<script>
import { openInit } from '@/init/bigdata'
import { statOpenCount,getAddress } from '@/api/https'
