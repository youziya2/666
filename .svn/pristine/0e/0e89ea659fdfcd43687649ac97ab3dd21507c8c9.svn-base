                    ...
                    <div class="bigdatatBtmLeftBtm">
                        <div class="batics">
                            ...
                            <div class="bigdatatBtmLeftBtmContent">
                                <span class="font14size999">{{ ufObj.tit45 }}: </span><span style="font-size:20px;color:#437BF5;font-weight:bold;">{{total}}</span>
                            </div>
                        </div>
...
<script>
import { fileInit } from '@/init/bigdata'
import { fileCount,getAddress } from '@/api/https'
