                    ...
                    <div class="bigdatatBtmLeftBtm">
                        <div class="batics">
                            ...
                            <div class="bigdatatBtmLeftBtmContent">
                                <span class="font14size999">{{ uhObj.tit39 }}: </span><span style="font-size:20px;color:#437BF5;font-weight:bold;">{{total}}</span>
                            </div>
                        </div>
...
<script>
import { registeredInit } from '@/init/bigdata'
import { registeredCount,getAddress } from '@/api/https'
...
export default {
    ...
    methods: {
        // 获取数据
        getData(){
            registeredCount(doRespone(this));
        },
        // 获取地方
