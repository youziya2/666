                    ...
                    <div class="bigdatatBtmLeftBtm">
                        <div class="batics">
                            ...
                            <div class="bigdatatBtmLeftBtmContent">
                                <span class="font14size999">{{ umObj.tit43 }}: </span><span style="font-size:20px;color:#437BF5;font-weight:bold;">{{total}}</span>
                            </div>
                        </div>
...
<script>
import { meetingInit } from '@/init/bigdata'
import { meetingCount,getAddress } from '@/api/https'
