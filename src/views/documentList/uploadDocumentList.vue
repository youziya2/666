        ...
        <div class="documentContent">
            <el-scrollbar style="width:100%;overflow-x: hidden;" :style="{height:windowHeight}">
                <div>
                    ...
                    <p style="color: red;margin: -20px -20px 20px 112px;">
                        温馨提示：上传文件只支持mp4、avi、jpg、png、gif格式！
                    </p>
                </div>
                <el-row :gutter="20">
                    <!-- 文件上传 -->
                            ...
                            <form enctype="multipart/form-data" class="uploadForm" style="position: relative;">
                                <div class="file-imgs">
                                    <input type="file" ref="img01" id="img01" :title="$buttonObj.clickFile" name="img01"
                                        multiple="multiple" @change="uploadMoreattach('img01')"
                                        accept=".mp4,.avi,.jpg,.png,.gif">
                                    <div class="show-imgs">
                        ...
                        <div class="documentLists" :class="item.listCheck?'documentListsActive':''"
                            ...
                            <div class="uplodownlo">
                                ...
                                <el-dialog title="" :visible.sync="dialogVisible" width="480px"
                                    ...
                                    <div style="text-align: left;height: 62px; margin-bottom: 10px;" v-for="(item,index) in productList" :key="index">
                                        <div style="float: left;line-height: 62px;">
                                            <el-checkbox 
                                            style="position: static;" 
                                            @change="getChoices(item.isckd,item.mac,index)" 
                                            :checked=item.isckd
                                            v-model="item.isckd"
                                            class="checkbox"
                                            :val=item.mac
